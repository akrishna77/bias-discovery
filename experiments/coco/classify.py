...
parser.add_argument("-g", "--num-gpus", default=8, type=int, metavar="N", help="number of GPUs to match (default: 8)")
...
def main():
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            model.load_state_dict(checkpoint["state_dict"], strict=False) if "state_dict" in checkpoint else print(
                "no state_dict found"
            )
...
def validate(val_loader, model, criterion):
    ...
    print(str(datetime.datetime.now()) + " * Err@1 {top1.avg:.3f} Err@5 {top5.avg:.3f}".format(top1=top1, top5=top5))
    return top1.avg
